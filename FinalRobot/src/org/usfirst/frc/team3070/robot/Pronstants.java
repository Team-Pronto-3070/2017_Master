...
static final int[] AUTO_TURN 
= {-60, 0, 60, 0}; //Degrees each mode should turn: left, centre, right, don't move TODO: Add other mode values
static final double[] FIRST_AUTO_STRAIGHT_DISTANCE 
= {5.0, 5.0, 5.0, 0}; //Feet each mode should travel 1st: left, centre, right, don't move TODO: Add other mode values
static final double[] SECOND_AUTO_STRAIGHT_DISTANCE 
= {2.0, 2.0, 2.0, 0}; //Feet each mode should travel 2nd: left, centre, right, don't move TODO: Add other mode values
...
static final double ANGLE_VARIANCE = .2; //The acceptable margin of error for turning
