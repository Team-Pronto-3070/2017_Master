	...
	//Outputs
		 ...
		 */
		 public void process(Mat source0) {
			...
			double[] rgbThresholdRed = {247.6618705035971, 255.0};
			double[] rgbThresholdGreen = {243.07553956834533, 255.0};
			double[] rgbThresholdBlue = {240.78237410071947, 255.0};
			rgbThreshold(rgbThresholdInput, rgbThresholdRed, rgbThresholdGreen, rgbThresholdBlue, rgbThresholdOutput);

			// Step Find_Blobs0:
			Mat findBlobsInput = rgbThresholdOutput;
			double findBlobsMinArea = 1;
			double[] findBlobsCircularity = {0.5755395683453237, 0.9402730375426621};
